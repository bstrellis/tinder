...
var zoomIntoProfile = function() {
  ...
  document.querySelector('.screen').appendChild(everythingButChoices);
  everythingButChoices.appendChild(pictureWindowEl);
  everythingButChoices.appendChild(personDataEl);
  everythingButChoices.appendChild(jobEl);
  everythingButChoices.appendChild(collegeEl);
  everythingButChoices.appendChild(distanceEl);
  everythingButChoices.appendChild(bioEl);
